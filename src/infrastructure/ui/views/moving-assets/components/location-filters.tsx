  ...
  return (
    <div className="tw-flex tw-flex-col tw-gap-4">
      <LandmarkFilterGroups
        ...
        onPinChange={view === "moving-assets" ? (status) => setPinnedFilter("location", "groups", status) : undefined}
      />
      <LandmarkFilterTypes
        ...
        onPinChange={view === "moving-assets" ? (status) => setPinnedFilter("location", "types", status) : undefined}
      />
      <LandmarkFilterNames
        ...
        onPinChange={view === "moving-assets" ? (status) => setPinnedFilter("location", "names", status) : undefined}
        includeAll={true}
      />
      <LocationFilterCountry
        ...
        onPinChange={
          view === "moving-assets" ? (status) => setPinnedFilter("location", "countries", status) : undefined
        }
      />
      <LocationFilterState
        countries={filters.location.countries ?? []}
        ...
        onPinChange={view === "moving-assets" ? (status) => setPinnedFilter("location", "states", status) : undefined}
      />
      <LocationFilterZipCode
        ...
        onPinChange={view === "moving-assets" ? (status) => setPinnedFilter("location", "zipCode", status) : undefined}
      />
    </div>
  );
}
