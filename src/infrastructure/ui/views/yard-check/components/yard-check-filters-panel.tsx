...
import { LandmarkFilters } from "./landmark-filters";
...
import { SensorFilters } from "@/views/yard-check/components/sensor-filters";
...
const FILTERS: FilterInfo[] = [
  {
    id: "landmark",
    label: "Landmark Filters",
    component: (view: View) => <LandmarkFilters view={view} />,
  },
  {
    id: "asset",
    label: "Asset Filters",
